        ...
        <Container>
          <FadeUp>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-foreground/60 font-sans">Users don&apos;t think in channels. Neither should your advertising. Engage them contextually throughout their day.</p>
            </div>
          </FadeUp>
            ...
            {[
              ...
              <motion.div key={i} variants={staggerItem}>
                <GlassCard className="p-8 h-full">
                  ...
                  <p className="text-foreground/60 font-sans text-sm leading-relaxed">{feature.desc}</p>
                </GlassCard>
              </motion.div>
            ))}
          </StaggerContainer>
