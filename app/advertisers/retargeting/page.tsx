            ...
            <FadeUp delay={0.2} className="hidden lg:block">
              ...
              <div className="relative w-full aspect-square max-w-md mx-auto">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="glass-card w-32 h-32 rounded-full flex items-center justify-center shadow-[0_0_50px_rgba(139,92,246,0.2)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeUp>
              <div className="flex flex-col gap-4">
                <GlassPanel className="p-4 flex items-center gap-4 border-[var(--color-brand-accent)]/20">
