        ...
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            <FadeUp delay={0.1} className="h-full">
              <GlassPanel className="p-8 h-full flex flex-col bg-gradient-to-br from-white/5 to-transparent min-h-[350px] lg:min-h-[500px]">
                ...
                <div className="flex-1 flex flex-col justify-between items-center w-full max-w-sm mx-auto">
                  {['SSP (15%)', 'Exchange (10%)', 'DSP (20%)', 'Trading Desk (10%)', 'Advertiser'].map((node, i) => (
                    <React.Fragment key={i}>
                      <div className="h-12 w-full glass-panel rounded-xl flex items-center justify-center text-sm font-medium border border-white/5 bg-background shadow-lg text-slate-300">
                        {node}
                      </div>
                      {i < 4 && <ArrowRight className="text-white/20 w-5 h-5 shrink-0 rotate-90 my-2" />}
                    </React.Fragment>
                  ))}
                </div>
              </GlassPanel>
            ...
            <FadeUp delay={0.2} className="h-full">
              <GlassPanel className="p-8 h-full flex flex-col bg-gradient-to-br from-[var(--color-brand-secondary)]/10 to-transparent min-h-[350px] lg:min-h-[500px] border-[var(--color-brand-secondary)]/20 shadow-[0_0_40px_rgba(var(--color-brand-secondary-rgb,56,189,248),0.05)]">
                ...
                <div className="flex-1 flex flex-col justify-between items-center w-full max-w-sm mx-auto">
                  ...
                  <div className="h-20 w-full glass-panel rounded-xl flex items-center justify-center text-lg font-medium border border-white/5 bg-background shadow-lg text-white">
                    Advertiser
                  </div>
        ...
        <Container>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <motion.div variants={staggerItem} className="md:col-span-2 lg:col-span-2">
              <GlassPanel className="h-full p-8 flex flex-col justify-end min-h-[200px] lg:min-h-[280px] bg-gradient-to-br from-white/5 to-transparent">
                <Target className="w-10 h-10 text-[var(--color-brand-secondary)] mb-6" />
                <div>
                  <h3 className="text-2xl font-medium text-white mb-2">Cross-Channel Access</h3>
                  <p className="text-slate-400">Reach your audience across desktop, mobile, and connected TV environments from a single unified interface with consolidated reporting and attribution.</p>
                </div>
              </GlassPanel>
            </motion.div>
            <motion.div variants={staggerItem}>
              <GlassPanel className="h-full p-8 flex flex-col justify-end min-h-[200px] lg:min-h-[280px] bg-gradient-to-br from-[var(--color-brand-primary)]/5 to-transparent">
                ...
                <div>
                  <h3 className="text-xl font-medium text-white mb-2">OpenRTB Bidding</h3>
                  <p className="text-slate-400 text-sm">Lightning-fast bid evaluation and submission using standard OpenRTB protocols.</p>
                </div>
              </GlassPanel>
            </motion.div>
            <motion.div variants={staggerItem}>
              <GlassPanel className="h-full p-8 flex flex-col justify-end min-h-[200px] lg:min-h-[280px]">
                ...
                <div>
                  <h3 className="text-xl font-medium text-white mb-2">Frequency Capping</h3>
                  <p className="text-slate-400 text-sm">Control exposure across all channels to avoid ad fatigue and wasted spend.</p>
                </div>
              </GlassPanel>
            </motion.div>
            <motion.div variants={staggerItem}>
              <GlassPanel className="h-full p-8 flex flex-col justify-end min-h-[200px] lg:min-h-[280px]">
                ...
                <div>
                  <h3 className="text-xl font-medium text-white mb-2">Bid Optimization</h3>
                  <p className="text-slate-400 text-sm">Algorithmic bidding to ensure you win the right impressions at the right price.</p>
                </div>
              </GlassPanel>
            </motion.div>
            <motion.div variants={staggerItem} className="md:col-span-2 lg:col-span-2">
              <GlassPanel className="h-full p-8 flex flex-col justify-end min-h-[200px] lg:min-h-[280px] bg-gradient-to-bl from-white/5 to-transparent">
                <ChartBar className="w-10 h-10 text-[var(--color-brand-secondary)] mb-6" />
                <div>
                  <h3 className="text-2xl font-medium text-white mb-2">Transparent Reporting</h3>
                  <p className="text-slate-400">Log-level data access and real-time dashboards give you absolute clarity on where your ads ran, what you paid, and how they performed.</p>
                </div>
              </GlassPanel>
            </motion.div>
            <motion.div variants={staggerItem}>
              <GlassPanel className="h-full p-8 flex flex-col justify-end min-h-[200px] lg:min-h-[280px]">
                ...
                <div>
                  <h3 className="text-xl font-medium text-white mb-2">Campaign Pacing</h3>
                  <p className="text-slate-400 text-sm">Intelligent budget distribution to ensure smooth delivery over your campaign flight.</p>
                </div>
              </GlassPanel>
            </motion.div>
          </StaggerContainer>
      ...
      <PageSection className="py-24 md:py-32">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <FadeUp delay={0.1}>
              <GlassPanel className="p-8 h-full flex flex-col min-h-[220px] lg:min-h-[300px] bg-gradient-to-br from-white/5 to-transparent">
                <Desktop className="w-10 h-10 text-[var(--color-brand-primary)] mb-6" />
                <div className="flex-1">
                  <h3 className="text-2xl font-medium mb-4">Web</h3>
                  <p className="text-slate-400 font-sans mb-8">Access premium desktop and mobile web inventory with high viewability and rich media support.</p>
                </div>
            ...
            <FadeUp delay={0.2}>
              <GlassPanel className="p-8 h-full flex flex-col min-h-[220px] lg:min-h-[300px] bg-gradient-to-br from-[var(--color-brand-secondary)]/5 to-transparent border-[var(--color-brand-secondary)]/10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-400 font-sans mb-8">Engage users in high-attention in-app environments across gaming, utility, and lifestyle apps.</p>
                </div>
            ...
            <FadeUp delay={0.3}>
              <GlassPanel className="p-8 h-full flex flex-col min-h-[220px] lg:min-h-[300px] bg-gradient-to-bl from-[var(--color-brand-primary)]/5 to-transparent border-[var(--color-brand-primary)]/10">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-400 font-sans mb-8">Deliver high-impact video ads on the biggest screen in the house with household-level targeting.</p>
                </div>
                <div className="flex items-center gap-2 text-sm font-mono text-[var(--color-brand-primary)]/70">
                  <ShieldCheck className="w-4 h-4" />
                  Fraud Protected
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeUp>
              <div className="max-w-xl">
                ...
                <p className="text-lg text-white/60 font-sans mb-8">
            ...
            <FadeUp delay={0.2}>
              <GlassPanel className="p-8 relative overflow-hidden group">
                ...
                <div className="text-sm font-mono text-slate-500 mb-8 flex justify-between items-center border-b border-white/10 pb-4 relative z-10">
                ...
                <div className="grid grid-cols-2 gap-6 relative z-10">
                  {/* Win Rate */}
                  <div className="group/metric p-6 bg-background/50 rounded-2xl border border-white/5 transition-all duration-500 hover:-translate-y-1 hover:bg-[var(--color-brand-secondary)]/5 hover:border-[var(--color-brand-secondary)]/30 hover:shadow-[0_0_30px_rgba(var(--color-brand-secondary-rgb,56,189,248),0.1)] cursor-default">
                    <div className="text-sm text-slate-400 mb-3 font-sans transition-colors group-hover/metric:text-white">Win Rate</div>
                    <div className="text-3xl md:text-4xl font-mono text-white group-hover/metric:text-[var(--color-brand-secondary)] transition-colors duration-300">
                      <NumberTicker value={42} /><span className="text-2xl md:text-3xl">.8%</span>
                    </div>
                  </div>
                  
                  {/* Avg CPM */}
                  <div className="group/metric p-6 bg-background/50 rounded-2xl border border-white/5 transition-all duration-500 hover:-translate-y-1 hover:bg-[var(--color-brand-primary)]/5 hover:border-[var(--color-brand-primary)]/30 hover:shadow-[0_0_30px_rgba(var(--color-brand-primary-rgb,136,192,64),0.1)] cursor-default">
                    <div className="text-sm text-slate-400 mb-3 font-sans transition-colors group-hover/metric:text-white">Avg CPM</div>
                    <div className="text-3xl md:text-4xl font-mono text-white group-hover/metric:text-[var(--color-brand-primary)] transition-colors duration-300">
                      $1.24
                    </div>
                  </div>
                  
                  {/* Fill Rate */}
                  <div className="group/metric p-6 bg-background/50 rounded-2xl border border-white/5 transition-all duration-500 hover:-translate-y-1 hover:bg-[var(--color-brand-accent)]/5 hover:border-[var(--color-brand-accent)]/30 hover:shadow-[0_0_30px_rgba(var(--color-brand-accent-rgb,250,204,21),0.1)] cursor-default">
                    <div className="text-sm text-slate-400 mb-3 font-sans transition-colors group-hover/metric:text-white">Fill Rate</div>
                    <div className="text-3xl md:text-4xl font-mono text-white group-hover/metric:text-[var(--color-brand-accent)] transition-colors duration-300">
                      <NumberTicker value={98} /><span className="text-2xl md:text-3xl">.2%</span>
                    </div>
                  </div>
                  
                  {/* p99 Latency */}
                  <div className="group/metric p-6 bg-background/50 rounded-2xl border border-white/5 transition-all duration-500 hover:-translate-y-1 hover:bg-white/5 hover:border-white/30 hover:shadow-[0_0_30px_rgba(255,255,255,0.05)] cursor-default">
                    <div className="text-sm text-slate-400 mb-3 font-sans transition-colors group-hover/metric:text-white">p99 Latency</div>
                    <div className="text-3xl md:text-4xl font-mono text-white transition-colors duration-300">
                      <NumberTicker value={45} /><span className="text-2xl md:text-3xl text-slate-400 group-hover/metric:text-white transition-colors">ms</span>
                    </div>
                  </div>
                </div>
              </GlassPanel>
