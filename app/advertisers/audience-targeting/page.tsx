          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <FadeUp delay={0.2}>
              <div className="glass-card bezel-inner p-8 rounded-3xl relative h-[300px] lg:h-[400px] flex flex-col justify-center gap-4">
                ...
                <div className="flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-lg ml-8">
                ...
                <div className="mt-4 p-4 border-t border-white/10 flex justify-between items-center">
                  <span className="text-sm text-white/60 font-sans">Est. Reach</span>
        ...
        <Container>
          <FadeUp>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-lg text-white/60 font-sans">Finding the right user doesn&apos;t matter if the environment isn&apos;t safe. Protect your brand reputation with ironclad controls.</p>
            </div>
          </FadeUp>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FadeUp delay={0.1}>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-white/60 font-sans text-sm">Automatically block ad placement near sensitive topics, violence, or adult content.</p>
              </div>
            </FadeUp>
            <FadeUp delay={0.2}>
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center mb-6">
                  <MagnifyingGlass className="w-8 h-8 text-white/80" />
                </div>
                <h4 className="text-xl font-bold mb-2">Domain Filtering</h4>
                <p className="text-white/60 font-sans text-sm">Deploy strict allowlists or blocklists to control exactly which publisher sites represent you.</p>
              </div>
            </FadeUp>
            <FadeUp delay={0.3}>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-white/60 font-sans text-sm">Pre-bid integration with leading verification partners to filter out invalid traffic and bots.</p>
              </div>
            </FadeUp>
          </div>
        </Container>
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeUp>
              ...
              <div className="flex flex-col gap-8 relative border-l border-white/10 ml-4 pl-8">
                <div className="relative">
                  ...
                  <p className="text-white/60 font-sans">Discover which segments are driving the best engagement and shift budget automatically.</p>
                </div>
                <div className="relative">
                  ...
                  <p className="text-white/60 font-sans">Modify bids based on device, time of day, and audience value to ensure optimal ROAS.</p>
                </div>
                <div className="relative">
                  ...
                  <p className="text-white/60 font-sans">A/B test different messaging against specific segments to find the perfect resonance.</p>
                </div>
              </div>
            </FadeUp>
            <FadeUp delay={0.2}>
              <GlassPanel className="p-8 relative overflow-hidden bg-gradient-to-br from-white/5 to-transparent border border-white/10 group hover:border-white/20 transition-all duration-300 hover:shadow-2xl">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[var(--color-brand-secondary)] to-[var(--color-brand-accent)]" />
                <div className="text-sm font-mono text-white/40 mb-8 border-b border-white/10 pb-4">Campaign Performance Trend</div>
                
                <div className="flex flex-col gap-6 relative z-10">
                  <div className="flex items-end justify-between group/metric hover:bg-white/5 p-2 -mx-2 rounded transition-colors">
                    <div>
                      <div className="text-sm text-white/60 font-sans mb-1">CPA (Cost per Action)</div>
                  ...
                  <div className="flex items-end justify-between group/metric hover:bg-white/5 p-2 -mx-2 rounded transition-colors">
                    <div>
                      <div className="text-sm text-white/60 font-sans mb-1">Conversion Rate</div>
                  ...
                  <div className="flex items-end justify-between group/metric hover:bg-white/5 p-2 -mx-2 rounded transition-colors">
                    <div>
                      <div className="text-sm text-white/60 font-sans mb-1">CTR</div>
