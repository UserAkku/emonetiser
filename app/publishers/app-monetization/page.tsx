...
export default function AppMonetizationPage() {
  ...
  return (
    <main className="flex flex-col w-full bg-background min-h-screen text-slate-200">
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <FadeUp delay={0.2} className="relative flex justify-center lg:justify-end w-full">
              <div className="relative w-full max-w-[300px] h-[600px] mx-auto lg:mx-0 rounded-[3rem] border-4 border-white/5 bg-black/40 p-4 flex flex-col gap-4 overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] backdrop-blur-xl">
                {/* Phone Notch */}
                ...
                <div className="flex-1 mt-8 flex flex-col gap-4 relative z-10">
                  ...
                  <div className="w-full bg-card rounded-2xl h-36 mt-4 flex flex-col justify-center items-center p-4 border border-[var(--color-brand-primary)]/30 text-center relative overflow-hidden group hover:border-[var(--color-brand-primary)]/60 transition-colors shadow-[0_0_20px_rgba(var(--color-brand-primary),0.05)] cursor-pointer">
                    <div className="absolute top-2 left-2 bg-black/50 text-[8px] font-mono uppercase tracking-widest px-1.5 py-0.5 rounded text-white/50 border border-white/10">Ad</div>
                  ...
                  {/* Native Ad Slot */}
                  <div className="w-full bg-card rounded-2xl h-24 flex items-center gap-4 p-4 border border-white/5 relative overflow-hidden group hover:border-white/20 transition-colors cursor-pointer mt-2">
                    <div className="absolute top-2 right-2 bg-black/50 text-[8px] font-mono uppercase tracking-widest px-1.5 py-0.5 rounded text-white/50 border border-white/10">Ad</div>
      ...
      <PageSection className="py-24 md:py-32 bg-white/[0.02]">
        <Container>
          <FadeUp className="mb-16">
            <h2 className="text-3xl md:text-5xl font-display text-white">Formats that convert</h2>
          </FadeUp>
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Rewarded Video - Wider/Taller */}
            <div className="group relative overflow-hidden rounded-3xl border border-white/5 bg-card p-8 lg:col-span-2 lg:row-span-2 flex flex-col min-h-[300px] lg:min-h-[400px] transition-all duration-500 hover:border-[var(--color-brand-primary)]/30 hover:shadow-[0_0_40px_rgba(var(--color-brand-primary-rgb,136,192,64),0.1)]">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="mt-auto">
                  ...
                  <div className="w-full h-2.5 bg-background border border-white/5 rounded-full overflow-hidden relative shadow-inner">
                    <motion.div 
                      initial={{ width: 0 }}
            ...
            {/* Interstitial */}
            <div className="group relative overflow-hidden rounded-3xl border border-white/5 bg-card p-8 flex flex-col min-h-[180px] lg:min-h-[220px] transition-all duration-500 hover:border-[var(--color-brand-secondary)]/30 hover:shadow-[0_0_30px_rgba(var(--color-brand-secondary-rgb,138,180,248),0.1)]">
            ...
            {/* Banner */}
            <div className="group relative overflow-hidden rounded-3xl border border-white/5 bg-card p-8 flex flex-col min-h-[180px] lg:min-h-[220px] transition-all duration-500 hover:border-white/20 hover:shadow-[0_0_30px_rgba(255,255,255,0.05)]">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-2xl font-display font-medium text-foreground mb-2 group-hover:text-white transition-colors">Banner</h3>
      ...
      <PageSection className="py-24 md:py-32">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeUp>
              <Eyebrow className="text-slate-400 mb-6">Developer First</Eyebrow>
              <h2 className="text-3xl md:text-5xl font-display text-white mb-10">One SDK. Endless scale.</h2>
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-center gap-4 text-lg text-slate-300">
                    <div className="p-2 bg-white/5 rounded-lg text-[var(--color-brand-primary)]">
            ...
            <FadeUp delay={0.2}>
              <div className="glass-card rounded-2xl border border-white/10 overflow-hidden bg-card">
                <div className="flex items-center px-4 py-3 bg-white/[0.04] border-b border-white/5 gap-2">
                ...
                <div className="p-6 overflow-x-auto text-sm font-mono leading-loose">
                  ...
                  <span className="text-slate-400">    _ application:</span> <span className="text-green-300">UIApplication</span>,<br />
                  <span className="text-slate-400">    didFinishLaunchingWithOptions:</span> [<span className="text-green-300">UIApplication.LaunchOptionsKey</span>: <span className="text-purple-400">Any</span>]?<br />
                  ...
                  <span className="text-slate-400">      appId:</span> <span className="text-orange-300">&quot;pub_123456789&quot;</span>,<br />
                  <span className="text-slate-400">      completion:</span> {'{'} status <span className="text-purple-400">in</span><br />
      ...
      <PageSection className="py-24 md:py-32 bg-white/[0.02] border-y border-white/5 overflow-hidden">
        <Container>
          <FadeUp className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display text-white mb-6">Real-Time In-App Bidding</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">Our auction dynamics ensure the highest paying ad always wins, maximizing your app revenue on every impression.</p>
          </FadeUp>
          ...
          <FadeUp delay={0.2} className="w-full max-w-5xl mx-auto mt-12">
            <div ref={containerRef} className="relative flex flex-col lg:flex-row w-full max-w-[1000px] items-center justify-between p-4 lg:p-10 h-[800px] lg:h-[500px] gap-12 lg:gap-0">
              ...
              <div className="flex flex-col gap-6 z-10">
                <div ref={dspARef} className="z-10 bg-card border border-white/10 text-muted-foreground px-6 py-3 rounded-xl shadow-lg font-medium text-sm w-[160px] text-center hover:border-white/30 transition-colors cursor-default">DSP A</div>
                <div ref={adNet1Ref} className="z-10 bg-card border border-white/10 text-muted-foreground px-6 py-3 rounded-xl shadow-lg font-medium text-sm w-[160px] text-center hover:border-white/30 transition-colors cursor-default">Ad Network 1</div>
                ...
                <div ref={exchangeBRef} className="z-10 bg-card border border-white/10 text-muted-foreground px-6 py-3 rounded-xl shadow-lg font-medium text-sm w-[160px] text-center hover:border-white/30 transition-colors cursor-default">Exchange B</div>
                <div ref={mediationRef} className="z-10 bg-card border border-white/10 text-muted-foreground px-6 py-3 rounded-xl shadow-lg font-medium text-sm w-[160px] text-center hover:border-white/30 transition-colors cursor-default">Mediation</div>
              </div>
              ...
              {/* Right: App User */}
              <div ref={userRef} className="z-10 bg-card border border-white/10 p-6 rounded-2xl flex flex-col items-center justify-center shadow-2xl relative overflow-hidden group hover:border-[var(--color-brand-primary)]/30 transition-colors w-[140px]">
