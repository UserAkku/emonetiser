          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <StaggerContainer className="space-y-4">
              ...
              {[
                ...
                <div key={i} className="flex gap-4 items-start p-5 rounded-2xl bg-rose-50 border border-rose-200">
            ...
            <StaggerContainer className="space-y-4">
              ...
              {[
                ...
                <div key={i} className="flex gap-4 items-start p-5 rounded-2xl bg-emerald-50 border border-emerald-200">
