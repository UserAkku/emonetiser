  ...
  return (
    <main className="flex flex-col w-full bg-background min-h-screen text-slate-200">
      ...
      <PageSection className="py-24 md:py-32 bg-white/[0.02]">
        <Container>
          <FadeUp>
            <h2 className="text-3xl md:text-5xl font-display text-white mb-16 text-center">The waterfall problem</h2>
          </FadeUp>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            <StaggerContainer className="space-y-6">
              <h3 className="text-xl font-medium text-slate-400 mb-8 border-b border-white/10 pb-4">Before</h3>
              {[
                ...
                <div key={i} className="glass-card bg-red-950/10 border-red-900/20 p-6 rounded-2xl flex gap-4 items-start">
                  <div className="p-3 rounded-lg bg-red-950/30 text-red-400">
      ...
      <PageSection className="py-24 md:py-32">
        <Container>
          <FadeUp>
            <h2 className="text-3xl md:text-5xl font-display text-white mb-16">Built for scale</h2>
          </FadeUp>
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <GlassPanel className="p-8 lg:col-span-2 lg:row-span-2 bg-gradient-to-br from-white/5 to-transparent flex flex-col justify-end min-h-[320px]">
              <Lightning className="w-10 h-10 text-[var(--color-brand-primary)] mb-6" />
              <h3 className="text-2xl font-medium text-white mb-2">Header Bidding</h3>
              <p className="text-slate-400">Advanced wrapper technology that executes auctions in the browser with zero latency impact.</p>
            </GlassPanel>
            <GlassPanel className="p-8">
              <ChartBar className="w-8 h-8 text-[var(--color-brand-accent)] mb-4" />
              <h3 className="text-xl font-medium text-white mb-2">Yield Optimization</h3>
              <p className="text-slate-400 text-sm">Dynamic floor pricing based on machine learning.</p>
            </GlassPanel>
            <GlassPanel className="p-8">
              <ShieldCheck className="w-8 h-8 text-[var(--color-brand-primary)] mb-4" />
              <h3 className="text-xl font-medium text-white mb-2">Fraud Prevention</h3>
              <p className="text-slate-400 text-sm">Built-in invalid traffic filtering and brand safety.</p>
            </GlassPanel>
            <GlassPanel className="p-8 lg:col-span-2">
              ...
              <p className="text-slate-400 text-sm">Granular analytics down to the ad unit and UTM source level.</p>
            </GlassPanel>
            <GlassPanel className="p-8">
              <CurrencyDollar className="w-8 h-8 text-[var(--color-brand-primary)] mb-4" />
              <h3 className="text-xl font-medium text-white mb-2">Floor Price Control</h3>
              <p className="text-slate-400 text-sm">Set custom floors by geo, device, or channel.</p>
            </GlassPanel>
            <GlassPanel className="p-8">
              <Gauge className="w-8 h-8 text-[var(--color-brand-accent)] mb-4" />
              <h3 className="text-xl font-medium text-white mb-2">Lazy Loading</h3>
              <p className="text-slate-400 text-sm">Only request ads when they enter the viewport.</p>
            </GlassPanel>
          </StaggerContainer>
        </Container>
      </PageSection>
      ...
      <PageSection className="py-24 md:py-32 bg-white/[0.02] border-y border-white/5">
        <Container>
          <FadeUp>
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
              <div>
                <Eyebrow className="text-slate-400 mb-4">Integration</Eyebrow>
                <h2 className="text-3xl md:text-5xl font-display text-white">Live in minutes</h2>
              </div>
            </div>
          </FadeUp>
          <div className="relative">
            {/* Timeline line */}
            <div className="hidden lg:block absolute top-1/2 left-0 w-full h-[2px] bg-slate-800 -translate-y-1/2 z-0 border-t border-dashed border-slate-600" />
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
              {[
                ...
                <div key={i} className="flex flex-col items-start bg-background p-6 rounded-2xl border border-white/5 relative">
      ...
      <PageSection className="py-24 md:py-32">
        <Container>
          <FadeUp className="mb-16">
            <h2 className="text-3xl md:text-5xl font-display text-white">Supported Formats</h2>
          </FadeUp>
            ...
            <FadeUp>
              <GlassCard className="p-10 relative">
                ...
                <div className="relative z-10">
                  <p className="text-xl md:text-2xl text-slate-200 font-medium leading-relaxed mb-8 pt-4">
