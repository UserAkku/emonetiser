  ...
  return (
    <main className="flex-1">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <FadeUp delay={0.2} className="relative h-[400px] lg:h-[500px] flex items-center justify-center">
              <svg viewBox="0 0 400 400" className="w-full h-full max-w-[400px]">
                ...
                <circle cx="200" cy="200" r="180" fill="none" stroke="currentColor" strokeWidth="1" className="text-white/10" />
                <circle cx="200" cy="200" r="120" fill="none" stroke="currentColor" strokeWidth="1" className="text-white/20" strokeDasharray="4 4" />
                <circle cx="200" cy="200" r="60" fill="none" stroke="currentColor" strokeWidth="1" className="text-white/30" />
            ...
            <StaggerContainer className="space-y-6">
              <motion.div variants={staggerItem}>
                <GlassPanel className="p-6 relative overflow-hidden group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                  ...
                  <h3 className="text-xl font-medium text-white mb-2">The Problem (2019)</h3>
                  <p className="text-slate-400">Fragmented exchanges causing up to 40% value loss in the supply path.</p>
                </GlassPanel>
              </motion.div>
              <motion.div variants={staggerItem}>
                <GlassPanel className="p-6 relative overflow-hidden group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                  <div className="absolute top-0 left-0 w-1 h-full bg-[var(--color-brand-primary)]" />
                  <h3 className="text-xl font-medium text-white mb-2">We Built It (2021)</h3>
                  <p className="text-slate-400">Launched our unified infrastructure handling both supply and demand directly.</p>
                </GlassPanel>
              </motion.div>
              <motion.div variants={staggerItem}>
                <GlassPanel className="p-6 relative overflow-hidden group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                  <div className="absolute top-0 left-0 w-1 h-full bg-[var(--color-brand-secondary)]" />
                  <h3 className="text-xl font-medium text-white mb-2">Google Certified (2022)</h3>
                  <p className="text-slate-400">Achieved official certification, validating our direct integration capabilities and scale.</p>
                </GlassPanel>
              </motion.div>
            </StaggerContainer>
          </div>
      ...
      <PageSection id="what-we-built" className="py-24 md:py-32">
        <Container>
          <FadeUp className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-medium text-white">Our Infrastructure</h2>
          </FadeUp>
            ...
            <FadeUp>
              <GlassPanel className="p-8 h-full border-t-2 border-t-[var(--color-brand-primary)] group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-3xl font-display text-white">SSP for Publishers</h3>
                </div>
                <ul className="space-y-6">
                  <li className="flex gap-4">
                    <ChartLineUp size={24} className="text-[var(--color-brand-primary)] shrink-0 mt-1" />
                    <div>
                      <h4 className="text-white font-medium mb-1 text-lg">Direct Integrations</h4>
                      <p className="text-sm text-slate-400">Prebid, OpenBidding, and direct VAST/VPAID tags with zero intermediaries.</p>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    <Target size={24} className="text-[var(--color-brand-primary)] shrink-0 mt-1" />
                    <div>
                      <h4 className="text-white font-medium mb-1 text-lg">Yield Optimization</h4>
                      <p className="text-sm text-slate-400">Dynamic flooring and real-time auction mechanics to maximize eCPM.</p>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    <ShieldCheck size={24} className="text-[var(--color-brand-primary)] shrink-0 mt-1" />
                    <div>
                      <h4 className="text-white font-medium mb-1 text-lg">Brand Safety</h4>
                      <p className="text-sm text-slate-400">Automated quality scanning ensuring premium ad experiences.</p>
                    </div>
                  </li>
                </ul>
              </GlassPanel>
            ...
            <FadeUp delay={0.2}>
              <GlassPanel className="p-8 h-full border-t-2 border-t-[var(--color-brand-secondary)] group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-3xl font-display text-white">DSP for Advertisers</h3>
                </div>
                <ul className="space-y-6">
                  <li className="flex gap-4">
                    <ShareNetwork size={24} className="text-[var(--color-brand-secondary)] shrink-0 mt-1" />
                    <div>
                      <h4 className="text-white font-medium mb-1 text-lg">Premium Supply Access</h4>
                      <p className="text-sm text-slate-400">Direct path to our proprietary O&O properties and premium publisher network.</p>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    <Graph size={24} className="text-[var(--color-brand-secondary)] shrink-0 mt-1" />
                    <div>
                      <h4 className="text-white font-medium mb-1 text-lg">Algorithmic Bidding</h4>
                      <p className="text-sm text-slate-400">Machine-learning driven bid optimization to hit strict ROAS and CPA goals.</p>
                    </div>
                  </li>
                  <li className="flex gap-4">
                    <FileText size={24} className="text-[var(--color-brand-secondary)] shrink-0 mt-1" />
                    <div>
                      <h4 className="text-white font-medium mb-1 text-lg">Transparent Reporting</h4>
                      <p className="text-sm text-slate-400">Log-level data access and full visibility into exactly where your budget goes.</p>
                    </div>
                  </li>
                </ul>
              </GlassPanel>
          ...
          <FadeUp delay={0.4} className="text-center">
            <div className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-white font-medium shadow-2xl">
      ...
      <PageSection className="py-24 md:py-32 bg-white/[0.02]">
        <Container>
          <FadeUp className="mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-display font-medium text-white mt-4">Verified & Certified</h2>
          </FadeUp>
          ...
          <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <motion.div variants={staggerItem}>
              <GlassPanel className="p-6 h-full flex flex-col group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-white mb-6 group-hover:bg-white/10 group-hover:scale-110 transition-all duration-300">
                  <Certificate size={24} />
                </div>
                <h3 className="text-xl font-medium text-white mb-1">Google CPP</h3>
                <span className="text-xs font-mono text-slate-400 mb-4">Issued 2022</span>
                <p className="text-sm text-slate-400 mt-auto">Certified Publishing Partner for scaling and monetizing apps & websites.</p>
              </GlassPanel>
            </motion.div>
            <motion.div variants={staggerItem}>
              <GlassPanel className="p-6 h-full flex flex-col group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                ...
                <h3 className="text-xl font-medium text-white mb-1">IAB Tech Lab</h3>
                <span className="text-xs font-mono text-slate-400 mb-4">Member</span>
                <p className="text-sm text-slate-400 mt-auto">Committed to developing and implementing global technical standards.</p>
              </GlassPanel>
            </motion.div>
            <motion.div variants={staggerItem}>
              <GlassPanel className="p-6 h-full flex flex-col group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                ...
                <h3 className="text-xl font-medium text-white mb-1">ads.txt Compliant</h3>
                <span className="text-xs font-mono text-slate-400 mb-4">Continuous</span>
                <p className="text-sm text-slate-400 mt-auto">Full support for authorized digital sellers for transparent supply chains.</p>
              </GlassPanel>
            </motion.div>
            <motion.div variants={staggerItem}>
              <GlassPanel className="p-6 h-full flex flex-col group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                ...
                <h3 className="text-xl font-medium text-white mb-1">OpenRTB 2.6</h3>
                <span className="text-xs font-mono text-slate-400 mb-4">Supported</span>
                <p className="text-sm text-slate-400 mt-auto">Implementing the latest real-time bidding protocols for efficiency.</p>
              </GlassPanel>
            </motion.div>
          </StaggerContainer>
        </Container>
      ...
      <PageSection className="py-24 md:py-32">
        <Container>
          <FadeUp className="mb-12">
            <h2 className="text-3xl md:text-5xl font-display font-medium text-white">Core Values</h2>
          </FadeUp>
          
          <StaggerContainer className="grid md:grid-cols-3 gap-6">
            <motion.div variants={staggerItem} className="md:col-span-2">
              <GlassPanel className="p-8 h-full bg-gradient-to-br from-white/5 to-transparent flex flex-col justify-end min-h-[200px] lg:min-h-[280px]">
                <Eyeglasses size={32} className="text-[var(--color-brand-secondary)] mb-6" />
                <h3 className="text-2xl font-medium text-white mb-2">Transparency</h3>
                <p className="text-slate-400">An open auction environment with no black-box mechanics, giving you complete visibility into every transaction.</p>
              </GlassPanel>
            </motion.div>
            ...
            <motion.div variants={staggerItem}>
              <GlassPanel className="p-8 h-full flex flex-col justify-end min-h-[200px] lg:min-h-[280px]">
                ...
                <p className="text-slate-400 text-sm">We build and maintain our infrastructure entirely in-house for maximum control.</p>
              </GlassPanel>
            </motion.div>
            ...
            <motion.div variants={staggerItem}>
              <GlassPanel className="p-8 h-full flex flex-col justify-end min-h-[200px] lg:min-h-[280px]">
                ...
                <p className="text-slate-400 text-sm">Constant optimization and rapid deployment of new AdTech capabilities.</p>
              </GlassPanel>
            </motion.div>
            ...
            <motion.div variants={staggerItem} className="md:col-span-2">
              <GlassPanel className="p-8 h-full bg-gradient-to-bl from-[var(--color-brand-primary)]/5 to-transparent flex flex-col justify-end min-h-[200px] lg:min-h-[280px]">
                ...
                <h3 className="text-2xl font-medium text-white mb-2">Accountability</h3>
                <p className="text-slate-400">Clear, granular reporting that holds our performance accountable to your bottom line.</p>
              </GlassPanel>
            </motion.div>
          </StaggerContainer>
        </Container>
      ...
      <PageSection className="py-24 md:py-32 bg-white/[0.02]">
        <Container>
          <FadeUp className="mb-12 text-center">
            <h2 className="text-3xl md:text-5xl font-display font-medium text-white">Leadership Team</h2>
          </FadeUp>
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-8">
            <motion.div variants={staggerItem}>
              <GlassPanel className="p-8 text-center h-full group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                ...
                <h3 className="text-2xl font-medium text-white mb-1">Founder & CEO</h3>
                <p className="text-sm font-mono text-[var(--color-brand-primary)] mb-6">AdTech Veteran</p>
                <p className="text-slate-400 text-sm leading-relaxed">15+ years in programmatic advertising, building sustainable yield strategies.</p>
              </GlassPanel>
            </motion.div>
            
            <motion.div variants={staggerItem}>
              <GlassPanel className="p-8 text-center h-full group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                <div className="w-20 h-20 rounded-2xl bg-white/5 text-white flex items-center justify-center text-2xl font-display font-medium mx-auto mb-6 group-hover:bg-white/10 group-hover:scale-110 transition-all duration-300">
                  CTO
                </div>
                <h3 className="text-2xl font-medium text-white mb-1">Chief Technology Officer</h3>
                <p className="text-sm font-mono text-slate-300 mb-6">OpenRTB Specialist</p>
                <p className="text-slate-400 text-sm leading-relaxed">Architect behind our unified exchange, specializing in high-throughput infrastructure.</p>
              </GlassPanel>
            </motion.div>
            ...
            <motion.div variants={staggerItem}>
              <GlassPanel className="p-8 text-center h-full group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                ...
                <h3 className="text-2xl font-medium text-white mb-1">VP Publisher Success</h3>
                <p className="text-sm font-mono text-[var(--color-brand-secondary)] mb-6">Yield Expert</p>
                <p className="text-slate-400 text-sm leading-relaxed">Dedicated to maximizing publisher revenue through advanced optimization techniques.</p>
              </GlassPanel>
            </motion.div>
          </StaggerContainer>
        </Container>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <FadeUp>
              <Link href="/publishers/web-monetization" className="block h-full transition-transform hover:-translate-y-2 duration-300">
                <GlassPanel className="p-12 h-full text-center border border-white/5 hover:border-[var(--color-brand-primary)]/50 group bg-gradient-to-b from-transparent to-[var(--color-brand-primary)]/5 shadow-2xl">
                  ...
                  <h3 className="text-4xl font-display font-medium text-white mb-4 group-hover:text-[var(--color-brand-primary)] transition-colors">For Publishers</h3>
                  <p className="text-slate-400 mb-10 max-w-sm mx-auto text-lg leading-relaxed">Maximize your inventory value with our direct SSP integration.</p>
            ...
            <FadeUp delay={0.1}>
              <Link href="/advertisers/programmatic-advertising" className="block h-full transition-transform hover:-translate-y-2 duration-300">
                <GlassPanel className="p-12 h-full text-center border border-white/5 hover:border-[var(--color-brand-secondary)]/50 group bg-gradient-to-b from-transparent to-[var(--color-brand-secondary)]/5 shadow-2xl">
                  ...
                  <h3 className="text-4xl font-display font-medium text-white mb-4 group-hover:text-[var(--color-brand-secondary)] transition-colors">For Advertisers</h3>
                  <p className="text-slate-400 mb-10 max-w-sm mx-auto text-lg leading-relaxed">Access premium, brand-safe inventory at scale through our DSP.</p>
