        ...
        >
          <div className={cn("mx-auto max-w-7xl px-6 lg:px-8 w-full flex items-center transition-all duration-500", scrolled ? "h-16" : "h-20")}>
            ...
            <Link href="/" className="flex items-center gap-2.5 shrink-0 mr-4">
              ...
              <span className="font-display text-base font-semibold tracking-tight">Emonetiser</span>
            </Link>
            ...
            {/* Mobile toggle */}
            <button
              className="ml-auto lg:hidden flex items-center justify-center h-8 w-8 rounded-lg border border-white/10 bg-white/5 text-muted-foreground hover:text-foreground transition-colors"
              ...
              {[
                ...
                <div key={group.label} className="mb-6">
                  <motion.p
                    ...
                    className="font-mono text-[10px] uppercase tracking-[0.18em] text-muted-foreground mb-3"
                  >
                    {group.label}
                  </motion.p>
                    ...
                    {group.links.map((link) => (
                      ...
                      >
                        <Link
                          ...
                          className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-muted-foreground hover:text-foreground hover:bg-white/5 transition-colors"
                        >
                          {link.label}
                        </Link>
                      </motion.div>
